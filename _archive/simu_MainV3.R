...
########################################################
#General setup
S=150000 #number of simulations per set of experiment characteristics
Ns=c(40,80,120)            #N
...
ver = 3                    #for output file names to track versions
    ...
    for (Kc in Kcs){
      for (dR2 in dR2s){
        for (nSig in nSigs){
          ...
          #Uniform distribution for covariate correlations
          #runif(n=1000,min=-.4, max=.4)
