...
- beta_x (0, small, medium, large.) - NEED TO DECIDE ON NON-zero effect sizes
- different n_obs  -  100, 200, 400, 1000
- n_covs - 4, 8, 16
- propotion good covs - .25, .5, .75
- beta_covs (vary number of 0 and size of non-zero) - NEED TO CONSIDER THIS EFFECT SIZE
- sigma_covs (uncorrelated, small, medium - among all or some or only ones related to y?) - KEEP AT 0 for now. Need to consider non-zero values
