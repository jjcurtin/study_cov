...
7.  Full lm without $X$ in the model
8.  LASSO (including $X$ in the model)
9.  LASSO without $X$ in the model
...
The total amount of data simulated equals 97,200,000 observations = 540 unique research settings $\times$ 20,000 simulations each $\times$ 9 methods. We will consider the data separated by the $X$ effect. <br>
