...
ggplot(
  ...
  geom_segment(aes(y = .40, x = .6, xend = 2.6)) +
  geom_segment(aes(y = .40, x = 2.8, xend = 9.2)) +
  geom_segment(aes(y = .35, x = 2.8, xend = 4.6)) +
  geom_segment(aes(y = .35, x = 5, xend = 6.8)) +
  geom_segment(aes(y = .35, x = 7.2, xend = 9)) +
  geom_text(
