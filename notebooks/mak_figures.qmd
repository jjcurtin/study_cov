...
method_linewidths <- c("No covariates" = .5,
                     "All covariates" = .5,
                     "p-hacking" = .7,
                     "Single covariate lm" = .7,
                     "Single covariate lm with X" = .7,
                     "All covariates lm" = .7,
                     "All covariates lm with X" = .7,
                     "All covariates LASSO" = .7,
                     "All covariates LASSO with X" = .7)
