...
d_full <- d_full |> 
  mutate(method = factor(method, 
                         ...
                         labels = c("No covariates", "All covariates", "p-hacking", 
                                    "Separate cov lm", "Separate cov lm with X", 
                                    "Simultaneous cov lm", "Simultaneous cov lm with X", 
                                    "Simultaneous cov LASSO", "Simultaneous cov LASSO with X")))
...
method_colors <- c("No covariates" = "#FF7D00",
                   ...
                   "p-hacking" = "#C92C04",
                   "Separate cov lm" = "#5489BA",
                   "Separate cov lm with X" = "#5489BA",
                   "Simultaneous cov lm" = "#664896",
                   "Simultaneous cov lm with X" = "#664896",
                   "Simultaneous cov LASSO" = "#4A7C59",
...
method_linetypes <- c("No covariates" = "solid",
                     ...
                     "p-hacking" = "solid",
                     "Separate cov lm" = "dashed",
                     "Separate cov lm with X" = "solid",
                     "Simultaneous cov lm" = "dashed",
                     "Simultaneous cov lm with X" = "solid",
                     "Simultaneous cov LASSO" = "dashed",
...
segment_labels <- tibble::tibble(
  ...
  label = c("A priori selection", "Data-driven selection", "Separate cov lm", "Simultaneous cov lm", "Simultaneous cov LASSO")
)
