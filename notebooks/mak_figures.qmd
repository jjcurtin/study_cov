...
method_linetypes <- c("No covariates" = "solid",
                     ...
                     "p-hacking" = "solid",
                     "Separate cov lm w/o" = "dashed",
                     "Separate cov lm with X" = "solid",
                     "Simultaneous cov lm w/o" = "dashed",
...
type_I_summary <- d_0 |>
  ...
  mutate(group = case_match(method,
                            ...
                            "Separate cov lm" ~ "Separate cov lm",
                            "Separate cov lm with X" ~ "Separate cov lm",
                            "Simultaneous cov lm" ~ "Simultaneous cov lm",
                            "Simultaneous cov lm with X" ~ "Simultaneous cov lm",
                            "Simultaneous cov LASSO" ~ "Simultaneous cov LASSO",
